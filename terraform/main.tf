...
module "add_cards_lambda" {
  ...
  lambda_handler               = "com.blitzar.cards.application.web.events.CardApplicationEventHandler"
  ...
  dynamodb_cards_by_bank_account_id_gsi_name = module.dynamodb.cards_by_bank_account_id_gsi_name
  ...
  sqs_card_application_dead_letter_queue_name  = module.sqs.card_application_dead_letter_queue_name
}
