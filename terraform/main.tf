...
module "ssm_parameters" {
  ...
  dynamodb_cards_by_bank_account_id_gsi_ssm_param_value   = "cards-by-bank-account-id-gsi-${var.environment}"

  sqs_card_application_queue_queue_ssm_param_value = "card-application-${var.environment}"
  sqs_card_application_dlq_ssm_param_value         = "card-application-dlq-${var.environment}"
}
...
module "dynamodb" {
  ...
  cards_by_bank_account_id_gsi_name = module.ssm_parameters.dynamodb_cards_by_bank_account_id_gsi_ssm_param_value
}

module "sqs" {
  source = "./modules/messaging/sqs"

  card_application_queue_name = module.ssm_parameters.sqs_card_application_queue_queue_ssm_param_value
  card_application_dlq_name   = module.ssm_parameters.sqs_card_application_dlq_ssm_param_value
}
