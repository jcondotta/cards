...
class ActivateCardControllerIT implements LocalStackTestContainer {
    ...
    public void shouldActivateCard_whenCardIdExists() {
        ...
        assertThat(updatedCard.getCardStatus()).isEqualTo(CardStatus.ACTIVE);
    }

    @Test
    void shouldEvictCacheKey_whenCardIsActivated() {
        var card = CardTestFactory.buildCard(BANK_ACCOUNT_ID_BRAZIL, CARDHOLDER_JEFFERSON);
        dynamoDbTable.putItem(card);
